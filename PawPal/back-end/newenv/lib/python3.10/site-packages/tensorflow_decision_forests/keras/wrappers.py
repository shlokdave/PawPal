...
class CartModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(CartModel, self).__init__(task=task,
      learner="CART",
...
class DistributedGradientBoostedTreesModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(DistributedGradientBoostedTreesModel, self).__init__(task=task,
...
class GradientBoostedTreesModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(GradientBoostedTreesModel, self).__init__(task=task,
...
class HyperparameterOptimizerModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(HyperparameterOptimizerModel, self).__init__(task=task,
...
class MultitaskerModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(MultitaskerModel, self).__init__(task=task,
      learner="MULTITASKER",
      learner_params=learner_params,
      features=features,
      exclude_non_specified_features=exclude_non_specified_features,
...
class RandomForestModel(core.CoreModel):
  ...
  def __init__(self,
    ...
    super(RandomForestModel, self).__init__(task=task,
